...
const messages: Record<Locale, Record<string, TranslationValue>> = {
  en: {
    ...
    'settings.syncIntervalHelp': 'Choose how often automatic Strava sync should run. The minimum interval is 5 minutes.',
    ...
    'settings.syncingHint': 'Loading new activities from Strava. They will appear here as soon as the sync finishes.',
    ...
    'settings.ratioLock': 'Keep running and cycling ratios linked',
    'settings.ratioUnlock': 'Edit running and cycling ratios independently',
    'settings.currentRunningPlan': ({ zone2, interval }) => `Running plan: ${zone2} : ${interval}. The running counter uses this saved ratio and still resets only when a true interval workout is detected.`,
    'settings.currentCyclingPlan': ({ zone2, interval }) => `Cycling plan: ${zone2} : ${interval}. The cycling counter uses this saved ratio and still resets only when a true interval workout is detected.`,
  ...
  de: {
    ...
    'settings.syncIntervalHelp': 'Lege fest, wie oft die automatische Strava-Synchronisierung laufen soll. Das Mindestintervall ist 5 Minuten.',
    ...
    'settings.syncingHint': 'Neue Aktivitäten werden von Strava geladen. Sie erscheinen hier, sobald die Synchronisierung abgeschlossen ist.',
    ...
    'settings.ratioLock': 'Lauf- und Radverhältnis gekoppelt halten',
    'settings.ratioUnlock': 'Lauf- und Radverhältnis getrennt bearbeiten',
    'settings.currentRunningPlan': ({ zone2, interval }) => `Laufplan: ${zone2} : ${interval}. Der Laufzähler verwendet dieses gespeicherte Verhältnis und wird weiterhin nur durch echte Intervall-Einheiten zurückgesetzt.`,
    'settings.currentCyclingPlan': ({ zone2, interval }) => `Radplan: ${zone2} : ${interval}. Der Radzähler verwendet dieses gespeicherte Verhältnis und wird weiterhin nur durch echte Intervall-Einheiten zurückgesetzt.`,
