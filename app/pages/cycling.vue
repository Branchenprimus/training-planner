...
const page = ref(1)
const pageSize = 20
const { data, pending } = await useFetch<PaginatedActivitiesResponse>(() => `/api/activities/cycling?page=${page.value}&pageSize=${pageSize}`, { watch: [page] })
</script>
...
<template>
  <section class="page-grid">
    ...
    <EmptyState
      ...
      title="No cycling activities"
      description="Connect Strava and sync to populate your cycling-specific dashboard."
    />
    <template v-else>
